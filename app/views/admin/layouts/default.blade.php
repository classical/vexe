            ...
            <div class="container">
    			...
    			<div class="collapse navbar-collapse navbar-ex1-collapse">
    				<ul class="nav navbar-nav">
    					...
    					<li{{ (Request::is('admin/managers*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/managers') }}}"><span class="glyphicon glyphicon-list-alt"></span> Quản lý</a></li>
    					<li{{ (Request::is('admin/reports*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/reports') }}}"><span class="glyphicon glyphicon-bullhorn"></span> Báo cáo</a></li>
